  ...
  return (
    <div className="h-full overflow-y-auto">
      ...
      <div className="max-w-4xl mx-auto px-6 pb-6">
        {/* System Builder */}
        <div className="mb-10">
          <div className="relative overflow-hidden rounded-2xl border border-cyan-500/20 bg-noir-900/60 p-6">
            ...
            <div className="relative flex flex-col md:flex-row md:items-center gap-4">
              ...
              <Button onClick={() => navigate("/builder")} className="self-start md:self-center">
                {t("builder.sectionCta")}
              </Button>
            </div>
          </div>
        </div>
            ...
            <div className="relative flex flex-col md:flex-row md:items-center gap-4">
              <div className="flex-1">
                <p className="text-xs font-mono text-amber-400/70 uppercase tracking-widest">
                  {t("interview.sectionLabel")}
                </p>
                <h2 className="font-display text-2xl text-white/90 mt-1">
                  {t("interview.sectionTitle")}
                </h2>
                <p className="text-sm text-white/70 mt-2 max-w-xl">
                  {t("interview.sectionSubtitle")}
                </p>
              </div>
              <Button onClick={() => navigate("/interview")} className="self-start md:self-center">
                {t("interview.sectionCta")}
              </Button>
            </div>
          </div>
        </div>
